...
Write code to declare variables for s0 with a value of 12.0, v0 with a value of 3.5, a with a value of 9.8, and t 
with a value of 10, and then write the code to compute s on the basis of these values. At the end of your code, 
...
double time = 10;
double s = initialPosition + (initialVelocity * time) + ((0.5) * (acceleration) * (time) * (time));
